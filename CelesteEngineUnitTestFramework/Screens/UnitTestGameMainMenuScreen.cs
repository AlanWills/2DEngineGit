...
namespace CelesteEngineUnitTestFramework
{
    ...
    public class UnitTestGameMainMenuScreen : MenuScreen
    {
        ...
        public UnitTestGameMainMenuScreen(string mainMenuScreenDataAsset = "Screens\\UnitTestGameMainMenuScreen") :
        ...
        {
            return AssetManager.GetData<BaseScreenData>("Screens\\StartupLogoScreen", true);
        }
